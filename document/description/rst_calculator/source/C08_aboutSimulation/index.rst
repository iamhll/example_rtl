...
rtl_calc_knl_add_knl
````````````````````

*  Function

   #. elaborate RTL design *calc_knl_add_knl*
   #. check RTL design *calc_knl_add_knl*
   #. simulate RTL design *calc_knl_add_knl*
   #. collect coverage of RTL design *calc_knl_add_knl*
   #. do simulation regression on RTL design *calc_knl_add_knl*
   #. do coverage regression on RTL design *calc_knl_add_knl*
...
*  Content
   ...
   .. table::
      ...
      ============================================= =========================================== ============
       ...
       rtl_calc_knl_add_knl/makefile                 daughter makefile
       rtl_calc_knl_add_knl/sim_calc_knl_add_knl.f   simulation files lists
       rtl_calc_knl_add_knl/sim_calc_knl_add_knl.v   mother testbench
       rtl_calc_knl_add_knl/sub_bench                directory for daughter testbench
       rtl_calc_knl_add_knl/check_data               directory for test vectors
       rtl_calc_knl_add_knl/simul_data               directory for simulation or coverage data   generated by command *make sim* or *make cov*
       rtl_calc_knl_add_knl/simul_data_regr          directory for regression data               generated by command *make sim_regr* or *make cov_regr*
      ============================================= =========================================== ============

*  Usage

      |  In the Linux server, change the directory to *simulation/rtl/rtl_calc_knl_add_knl*,
      |  then you can
