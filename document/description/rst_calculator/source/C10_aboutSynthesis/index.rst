...
*  Function
   ...
   #. synthesize design *calc_knl_add_knl* with DC
...
*  Content
      ...
      .. table::
         ...
         ==================================== ==================================================== ============
          ...
          dc_calc_knl_add_knl/makefile         daughter makefile
          dc_calc_knl_add_knl/setCst.tcl       constraint related DC Tcl
          dc_calc_knl_add_knl/setPth.tcl       timing path related DC Tcl
          dc_calc_knl_add_knl/session_2.000    synthesis session with a clock period of 2.000 ns    generated by *make syn*
          dc_calc_knl_add_knl/session_10.000   synthesis session with a clock period of 10.000 ns   generated by *make syn DATA_PRD_CLK=10.000*
         ==================================== ==================================================== ============
...
*  Usage
      ...
      |  Change directory to synthesis/design_compiler/dc_calc_knl_add_knl,
      |  then you can
